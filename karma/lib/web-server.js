...
var createWebServer = function(injector, emitter) {
  ...
  // myhack
  ///Users/dbaron/projects/LEDITA/node_modules/karma/lib
  var pathToMyCert = path.resolve(__dirname, '../../../server/cert/cert.pem');
  // var pathToMyCert = path.join(__dirname, '../../../server/cert');
  console.log('myhack pathToMyCert: ' + pathToMyCert);
  var options = {
  ...
  console.log('myhack: creating https server');    
