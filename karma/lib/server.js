...
var start = function(injector, config, launcher, globalEmitter, preprocess, fileList, webServer,
  ...
  webServer.listen(config.port, function() {
    // myhack: output https instead of http
    log.info('Karma v%s server started at https://%s:%s%s', constant.VERSION, config.hostname,
...
var createSocketIoServer = function(webServer, executor, config) {
  //myhack: add secure true option
  //{key:privateKey,cert:certificate,ca:ca}
  console.log('myhack: adding secure true option to io.listen');
